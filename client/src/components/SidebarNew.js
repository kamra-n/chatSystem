...
import { FiArrowRight, FiArrowUpLeft, FiArrowUpRight } from "react-icons/fi";
        ...
        <div className='w-full h-full grid grid-cols-[48px,1fr] bg-white'>
            <div className='bg-slate-100 w-12 h-full rounded-tr-lg rounded-br-lg py-5 text-slate-600 flex flex-col justify-between'>
                <div>
                    ...
                    <a href={`https://qaqf.co.uk/crm/loginadmin?em=${user?.email}&ud=${user._id}`} target='_blank'>
                        <div title='Visit Crm' onClick={() => setOpenSearchUser(true)} className='w-12 h-12 flex justify-center items-center cursor-pointer hover:bg-slate-200 rounded' >
            ...
            <div className='w-full'>
                <div className='h-16 flex flex-row items-center justify-evenly'>
                    ...
                    <a href={`https://qaqf.co.uk/crm/loginadmin?em=${user?.email}&ud=${user._id}`} target='_blank'>
                        <button class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-1 px-1 rounded text-xs" >
                            VISIT CRM
                        </button>
                    </a>
